...
const AdminNavbar = () => {
  ...
  const handleLogout = () => {
    ...
    window.location.href = "/admin/login"; // Navigate and reload to clear state
  };
  ...
  const navItems = [
    ...
    { title: "Table Bookings", icon: Calendar, path: "/dashboard/table-bookings" },
  ];
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5">
                  ...
                  <div className="border-t border-gray-200">
                    <div className="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-gray-100 flex items-center">
                      {isLoggedIn ? (
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-blue-600 text-white rounded shadow-md hover:bg-blue-700 flex items-center"
                        >

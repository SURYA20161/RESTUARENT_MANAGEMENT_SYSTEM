    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [userRes, productRes, orderCountRes, ordersRes] = await Promise.all([
          fetch('http://localhost:3000/user/count', { headers }),
          fetch('http://localhost:3000/product/count', { headers }),
          fetch('http://localhost:3000/order/count', { headers }),
          fetch('http://localhost:3000/order/all', { headers })
        ]);

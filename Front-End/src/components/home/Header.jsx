      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-[#f5f0e663] text-[#7C6145] backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
          ...
          <h1 className="text-3xl font-bold text-[#7C6145]">
            <Link to="/">Deccan Restaurent</Link>
          </h1>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {dropdownOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg p-2 flex flex-col space-y-2">
                      <Link
                        to="/profile"
                        className="px-4 py-2 text-[#5A6E48] hover:bg-[#D6A75C] rounded-lg transition-all flex items-center"
                      ...
                      <button
                        ...
                        className="px-4 py-2 text-[#5A6E48] hover:bg-[#D6A75C] rounded-lg transition-all flex items-center w-full text-left"
                      >
            ...
            <div className="mt-4">
              {isAuthenticated ? (
                <>
                  ...
                  <Link
                    to="/profile"
                    className="block mt-2 bg-[#2F5233] text-white px-6 py-2 rounded-full font-medium hover:bg-[#D6A75C] transition-all"
                  ...
                  <button
                    onClick={handleLogout}
                    className="mt-2 bg-red-600 text-white px-6 py-2 rounded-full font-medium hover:bg-red-700 transition-all"
                  >
                    Logout
                  </button>
                </>

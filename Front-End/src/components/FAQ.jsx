          ...
          <div className="relative flex flex-col lg:flex-row items-start justify-between gap-8 w-full mt-8"> {/* Flex row layout for larger screens */}
            ...
            <div className="text-black text-left flex-grow">
              ...
              <p className="text-sm sm:text-base mb-6">
                1st Floor, MOB-9363528096, GP Block, Sector V, Kovilpatti, Tamil Nadu 628503
              </p>
              ...
              <p className="text-sm sm:text-base mb-6">
                Yes, Deccan Restaurent offers event hosting for private gatherings, birthdays. Please contact us for details and booking.
              </p>

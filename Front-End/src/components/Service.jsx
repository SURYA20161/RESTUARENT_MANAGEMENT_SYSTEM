  ...
  return (
    ...
    <div className="mx-4 sm:mx-16 my-12 sm:my-24 p-6 sm:p-8 border-dotted border-black border-2">
      ...
      <p className="py-4 sm:py-8 px-4 sm:px-16 text-2xl sm:text-5xl text-[#100f0e] rounded-md">
        We at Deccan Restaurent are serving our customers for over a decade. Learn more about our high-quality services and unique dining experiences that will exceed your expectations.
      </p>
      <div className="flex justify-center mt-6 sm:mt-12">
        <a href="/contact" className="px-6 py-2 bg-yellow-400 text-black rounded-md hover:bg-yellow-500">
          Contact Us
        </a>
      </div>
    </div>
